...
public class ChromeDriverManager extends BaseDriverManager {
    ...
    /**
     * Sets up initial ChromeDriver configuration.
     * Installs ChromeDriver using WebDriverManager.
     */
    @Override
    protected void setupDriver() {
        try {
            ...
            logger.error("Error occurred during ChromeDriver setup: {}", e.getMessage());
